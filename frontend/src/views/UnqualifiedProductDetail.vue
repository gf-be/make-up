  ...
  <div class="unqualified-product-detail" v-loading="loading">
    ...
    <el-card v-if="detail" class="detail-card" shadow="never">
      ...
      <el-descriptions :column="2" border>
        ...
        <!-- <el-descriptions-item label="生产企业省市">{{ [detail.manufacturer_province, detail.manufacturer_city].filter(Boolean).join(' / ') || '-' }}</el-descriptions-item> -->
        <el-descriptions-item label="样品省市">{{ [detail.sampled_province, detail.sampled_city].filter(Boolean).join(' / ') || '-' }}</el-descriptions-item>
